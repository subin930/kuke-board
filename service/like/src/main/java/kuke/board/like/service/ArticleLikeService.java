...
public class ArticleLikeService {
    ...
    public void likePessimisticLock1(Long articleId, Long userId) {
        ...
        if(result == 0) {
            ...
            // 트래픽이 순식간에 몰릴 수 있는 상황에는 유실될 수 있으므로, 게시글 생성 시점에 미리 0으로 초기화 해둘 수도 있음
    ...
    public void likePessimisticLock2(Long articleId, Long userId) {
        ...
        articleLikeCountRepository.save(articleLikeCount); //새로 생성된 경우가 존재할 수 있으니 명시적으로 save
    }
